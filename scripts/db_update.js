...
async function updateArticle() {
  ...
  const richContent = `<p>UNESCO has officially partnered with Coursera and LG AI Research to roll out the Global MOOC on the Ethics of AI. This free initiative aims to equip students, researchers, and professionals with fundamental skills in responsible technology deployment.</p>
...
<div class="geo-faq">
  ...
  await client.execute({
    ...
    args: [richContent, Date.now(), slug]
  });
